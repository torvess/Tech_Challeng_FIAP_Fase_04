...
with tab2:
    ...
    st.image(r'https://github.com/torvess/Tech_Challeng_FIAP_Fase_04/tree/main/Midias\gaf1_serie_temporal.png')
    ...
    st.image(r'https://github.com/torvess/Tech_Challeng_FIAP_Fase_04/tree/main/Midias\gaf2_boxplot_preco_por_ano.png')
    ...
    st.image(r'https://github.com/torvess/Tech_Challeng_FIAP_Fase_04/tree/main/Midias\gaf_3_producao_preco_por_ano.png')
    ...
    st.image(r'https://github.com/torvess/Tech_Challeng_FIAP_Fase_04/tree/main/Midias\gaf4_crescimento_barris_por_ano.png')
    ...
    st.image(r'https://github.com/torvess/Tech_Challeng_FIAP_Fase_04/tree/main/Midias\gaf5_top_paises_producao.png')
    ...
    st.image(r'https://github.com/torvess/Tech_Challeng_FIAP_Fase_04/tree/main/Midias\gaf6_producao_consumo_anual.png')

    st.markdown('Top 10 países com maior consumo de energia')

    st.image(r'https://github.com/torvess/Tech_Challeng_FIAP_Fase_04/tree/main/Midias\gaf7_top_paises_maior_consumo_energia.png')

    st.subheader('PIB Mundial')

    st.image(r'https://github.com/torvess/Tech_Challeng_FIAP_Fase_04/tree/main/Midias\gaf8_crescimento_pib.png')
    ...
    st.image(r'https://github.com/torvess/Tech_Challeng_FIAP_Fase_04/tree/main/Midias\gaf9_desempenho_acoes.png')
    ...
    st.image(r'https://github.com/torvess/Tech_Challeng_FIAP_Fase_04/tree/main/Midias\gaf10_desempenho_acoes2.png')

    st.subheader('Taxa de Juros')

    st.image(r'https://github.com/torvess/Tech_Challeng_FIAP_Fase_04/tree/main/Midias\gaf11_taxa_juros.png')
    ...
    st.image(r'https://github.com/torvess/Tech_Challeng_FIAP_Fase_04/tree/main/Midias\gaf12_juros_emprestimo.png')
    ...
    st.image(r'https://github.com/torvess/Tech_Challeng_FIAP_Fase_04/tree/main/Midias\gaf13_taxa_juros_razao_capital_bancario_pais.png')
    ...
    st.image(r'https://github.com/torvess/Tech_Challeng_FIAP_Fase_04/tree/main/Midias\gaf14_crise_2008.png')

    st.image(r'https://github.com/torvess/Tech_Challeng_FIAP_Fase_04/tree/main/Midias\gaf15_desempenho_acoes_2007_a_2009.png')
    ...
    st.image(r'https://github.com/torvess/Tech_Challeng_FIAP_Fase_04/tree/main/Midias\gaf16_impacto_covid.png')

    st.image(r'https://github.com/torvess/Tech_Challeng_FIAP_Fase_04/tree/main/Midias\gaf17_desempenho_acoes_tempos_covid.png')
    ...
    st.image(r'https://github.com/torvess/Tech_Challeng_FIAP_Fase_04/tree/main/Midias\gaf18_pib_tempos_covid.png')
    ...
    st.image(r'https://github.com/torvess/Tech_Challeng_FIAP_Fase_04/tree/main/Midias\gaf19_taxa_juros_tempos_covid.png')
    ...
    st.image(r'https://github.com/torvess/Tech_Challeng_FIAP_Fase_04/tree/main/Midias\gaf20_preco_mensal_petroleo_tempos_covid.png')
